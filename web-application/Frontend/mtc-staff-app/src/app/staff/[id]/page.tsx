...
const STATUS_CONFIG: Record<string, { label: string; color: string; bg: string }> = {
    ...
    meeting: { label: "In Meeting", color: "#C62828", bg: "#FFEBEE" },
    leave: { label: "On Leave", color: "#E65100", bg: "#FFF3E0" },
    offline: { label: "Offline", color: "#616161", bg: "#F5F5F5" },
    busy: { label: "Busy", color: "#6A1B9A", bg: "#F3E5F5" },
};
...
export default function StaffDetailPage() {
    ...
    if (!staff) {
        return (
            ...
            >
                <p style={{ fontSize: 16, color: "var(--text-secondary)" }}>Staff not found</p>
                <button
                    onClick={() => router.back()}
